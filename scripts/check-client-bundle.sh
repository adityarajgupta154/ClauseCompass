...
FORBIDDEN='GEMINI_API_KEY|ANTHROPIC_API_KEY|OPENAI_API_KEY|SESSION_SECRET|SESSION_STORE_TOKEN|SESSION_STORE_KEY|SESSION_STORE_URL|KV_REST_API_TOKEN|UPSTASH_REDIS_REST_TOKEN|REDIS_URL|sk-ant-|redis://|rediss://'

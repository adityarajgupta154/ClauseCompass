...
async function buildAll() {
  ...
  await esbuild({
    ...
    external: [
      "*.node",
      // pdf.js is loaded from node_modules at runtime: its legacy build resolves
      // its worker relative to its own file and optionally requires the native
      // @napi-rs/canvas package (excluded from the install; text extraction

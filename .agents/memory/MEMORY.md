...
- [Sessions](sessions.md) — opened at Continue, no resume after refresh, delete clears the client cache, client mirrors the server clock; sealed Redis store over REST or own RESP2 socket (drop rules, plaintext gate, real-Redis check), Vercel wiring.
